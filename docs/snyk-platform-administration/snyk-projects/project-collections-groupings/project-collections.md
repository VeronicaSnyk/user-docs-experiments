...
4.  Enter the name of the collection you would like to add your selected Projects to and click **Add to collection**.
    ...
    <figure><img src="../../../.gitbook/assets/Screenshot 2023-11-14 at 12.07.enter-certificate-domains-supported-set-connection.png" alt="Enter a name for your collection"><figcaption><p>Enter a name for your collection</p></figcaption></figure>
...
3.  Choose the option to rename or delete the collection.&#x20;
    ...
    <figure><img src="../../../.gitbook/assets/Screenshot 2023-11-14 at 12.12.5enter-details-snyk-google.png" alt="Click the three dots next to the collection you want to configure and either rename or delete the collection"><figcaption><p>Click the three dots next to the collection you want to configure and either rename or delete the collection</p></figcaption></figure>

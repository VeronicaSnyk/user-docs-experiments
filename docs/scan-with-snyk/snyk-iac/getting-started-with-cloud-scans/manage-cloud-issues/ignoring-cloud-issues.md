...
6. Select **Confirm**.\
   ...
   ![Pending ignore state displayed in issue panel](<../../../../.gitbook/assets/example-ignored-cloud-issue-snyk-web-ui.png>)
...
3. The message "Issue successfully unignored and will be applied on next scan" appears.\
   ...
   ![Unignore pending state in the issue panel](<../../../../.gitbook/assets/unignore-pending-state-issue-panel.png>)

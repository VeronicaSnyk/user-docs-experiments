---
description: Scan your CocoaPods project for vulnerabilities in GitHub Actions using the Snyk CocoaPods action.
---
...
Using `--sarif-file-output` [Snyk CLI option](../../snyk-cli/cli-commands-and-options-summary.md) and the GitHub SARIF upload action, you can upload Snyk scan results to GitHub Code Scanning as shown in the example that follows.

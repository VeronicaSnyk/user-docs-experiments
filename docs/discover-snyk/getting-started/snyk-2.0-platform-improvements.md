...
| ---------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------- |
| Navigation       | <p>A unified menu with a new scope selector. </p><p></p><p>Context-aware shortcuts reduce common tasks to two or three clicks.</p>                                     | April 2026 (Early Access) |
...
| Issue triage     | <p>Snyk prioritizes issues based on exploitability, reachability, and business impact. </p><p></p><p>Use bulk actions to fix similar issues across Snyk Projects. </p> | In development            |

...
* The [language and package manager](../../../../supported-languages/supported-languages-package-managers-and-frameworks.md) you use, as determined by the manifest file type
...
See [Supported languages, package managers, and frameworks](../../../../supported-languages/supported-languages-package-managers-and-frameworks.md) for more information about supported languages.
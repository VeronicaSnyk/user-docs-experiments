---
description: Identify what malicious packages are, how Snyk detects them across popular registries, and what steps to take when malicious packages appear in your Projects.
---

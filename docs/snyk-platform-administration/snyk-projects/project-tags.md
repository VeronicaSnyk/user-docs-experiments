...
<figure><img src="../../.gitbook/assets/Screenshot 2023-01-24 at 08.23.enter-certificate-domains-supported-set-connection.png" alt="Filter by tag option"><figcaption><p>Filter by tag option</p></figcaption></figure>

...
* [Manage Tenants, Groups and Organizations](snyk-admin.md#manage-tenant-groups-and-organizations)
...
* [The Snyk workspace](snyk-admin.md#the-snyk-workspace)
* [User types](snyk-admin.md#user-types)
* [Snyk Admin tools](snyk-admin.md#admin-tools)

...
For more information, see [Automated pull request creation for new fixes](../../../scan-with-snyk/pull-requests/snyk-pull-or-merge-requests/enable-automatic-fix-prs.md).
{% endhint %}

...
For more information on how integrations use fix and upgrade pull requests, see [Enable automatic upgrade PRs for new dependency upgrades](snyk-pull-or-merge-requests/enable-automatic-upgrade-prs-for-new-dependency-upgrades.md).

...
<figure><img src="../../../.gitbook/assets/code-analysis-feature-pull-request-status-checks.png" alt=""><figcaption><p>Code analysis feature for pull request status checks</p></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/configuration-details-pr-comment-experience.png" alt=""><figcaption><p>Configuration details for the PR Comment experience</p></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/issue-summary-comment-feature-pull-request-experience.png" alt=""><figcaption><p>Issue summary comment feature for pull request experience</p></figcaption></figure>
...
Snyk Agent fix in the PR is in [Early Access](../../../discover-snyk/getting-started/snyk-release-process.md#early-access-features) and works only on inline comments created after the feature is enabled.
{% endhint %}
...
* You can use the `@snyk /fix` command only for automatically fixable vulnerabilities. Snyk identifies these in inline comments with a zap icon and a command description. See the [Fix code vulnerabilities automatically](../../snyk-code/manage-code-vulnerabilities/fix-code-vulnerabilities-automatically.md) page for supported languages and limitations.
* Fixes expire after the time displayed in each suggestion, based on the [How Snyk handles your data](../../../snyk-data-and-governance/how-snyk-handles-your-data.md#cache-retention-period-related-to-vulnerability-source-data) page. After expiration, you can request a new fix using the `@snyk /fix` command.
* [Snyk Code Local Engine](../../snyk-code/snyk-code-local-engine.md) does not support Snyk Agent fixes in pull requests.
* You can use the `@snyk /fix` and `@snyk /apply #` commands only as replies to inline comments created by Snyk. Snyk does not process commands created on other comment threads.
...
<figure><img src="../../../.gitbook/assets/configuration-details-enable-inline-comments.png" alt=""><figcaption><p>Configuration details to enable Inline Comments</p></figcaption></figure>

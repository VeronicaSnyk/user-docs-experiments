...
3.  Configure the script with the following attributes:
    ...
    <figure><img src="../../.gitbook/assets/script-attributes-configuration-jamf.png" alt="Script attributes configuration in Jamf"><figcaption><p>Script attributes configuration in Jamf</p></figcaption></figure>

...
4.  Click **Add Component**, **Then,** and select **Create Issue**. Select a project and issue type.\\
    ...
    <figure><img src="../../.gitbook/assets/2024-12-13_10-19-enter-certificate-domains-supported-set-connection.png" alt=""><figcaption><p>Add an action and create issue for the new rule</p></figcaption></figure>

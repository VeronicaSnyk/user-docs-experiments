...
* If your Snyk tenant is on a non-default Snyk environment (anything other than SNYK-US-1), you must add the [regional broker server URL](../../../snyk-data-and-governance/regional-hosting-and-data-residency.md#broker-server-urls) to the Docker commands: `-e BROKER_SERVER_URL=<YOUR_REGIONAL_URL>`&#x20;

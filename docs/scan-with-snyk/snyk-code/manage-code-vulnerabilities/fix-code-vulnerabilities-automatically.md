...
For more information, see [How Snyk handles your data](../../../snyk-data-and-governance/how-snyk-handles-your-data.md).
{% endhint %}
...
* Enable [Snyk Code](../../../implementation-and-setup/enterprise-implementation-guide/trial-limitations.md).
* Install the Snyk IDE plugin for [VS Code](https://marketplace.visualstudio.com/items?itemName=snyk-security.snyk-vulnerability-scanner-preview), [Visual Studio](https://marketplace.visualstudio.com/items?itemName=snyk-security.snyk-vulnerability-scanner-vs-2022), [Eclipse](https://marketplace.eclipse.org/content/snyk-security-code%E2%80%8B-open-source%E2%80%8B-iac-configurations), or [JetBrains IDEs](../../../developer-tools/snyk-ide-plugins-and-extensions/jetbrains-plugin/).
...
<figure><img src="../../../.gitbook/assets/opening-snyk-code-vulnerability-panel.png" alt="Opening the Snyk Code vulnerability panel"><figcaption><p>Opening the Snyk Code vulnerability panel</p></figcaption></figure>
...
1. Enable automated fixes in Snyk Preview in your [IDE plugin or extension](../../../developer-tools/snyk-ide-plugins-and-extensions/).
2. Save your files and [trigger a scan](../../../developer-tools/snyk-cli/scan-and-maintain-projects-using-the-cli/snyk-cli-for-snyk-code/scan-source-code-with-snyk-code-using-the-cli.md).
...
<figure><img src="../../../.gitbook/assets/vulnerability-has-fixed.png" alt="Vulnerability has been fixed"><figcaption><p>Vulnerability has been fixed</p></figcaption></figure>

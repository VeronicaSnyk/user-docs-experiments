...
| Online community                                                                                                          | ✔                                                                                                             |
| Support resource and ticket routing. For details, see [Silver Support below](legacy-success-offerings.md#silver-support). | <p>Pooled technical support</p><p> </p><p>Priority path for escalation</p>                                    |
| Hours of operation. For details, see [Silver Support below](legacy-success-offerings.md#silver-support).                  | 24x7                                                                                                          |
| Initial Support response SLA For details, see [Silver Support below](legacy-success-offerings.md#silver-support).         | <ul><li>Urgent (1): 2 hrs</li><li>High (2): 4 hrs</li><li>Normal (3): 8 hrs</li><li>Low (4): 12 hrs</li></ul> |

---
description: Scan, prioritize, and fix security vulnerabilities in code, open-source dependencies, container images, and infrastructure as code configurations using the Snyk platform.
---

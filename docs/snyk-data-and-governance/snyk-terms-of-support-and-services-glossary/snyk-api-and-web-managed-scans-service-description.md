...
| Diamond   | 100 - 250            | 20                                                      |
| Sapphire  | 250 - 500            | 50                                                      |
| Emerald   | 500+                 | 120 (or custom-scoped hours specified on an Order Form) |
...
* Monthly report of:
  * Scans performed (completed or failed)
...
### Accessible target environments
...
* Customers are responsible for providing appropriate authentication and authorization credentials to access the protected areas of their web applications and APIs.
* Snyk assumes that these credentials will be managed securely by the customer. Customers can use our secure file-sharing solution.
...
### Clear communication of service requests
...
### Understanding of service limitations

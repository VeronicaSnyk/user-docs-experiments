...
1. From the **Organization** list, choose an Organization in the Group that you are working with.\
   <img src="../../../../.gitbook/assets/switch_org_02oct202okta-saml-application-creation.png" alt="Choose Organization" data-size="original">
2.  From the same **Organization** dropdown, click **+Create new Organization.**

    <figure><img src="../../../../.gitbook/assets/clone-organization1_02oct202okta-saml-application-creation.png" alt="Select +Create new Organization"><figcaption><p>Select +Create new Organization</p></figcaption></figure>
...
5.  Review the summary of what will be copied across to the new Organization and click **Create organization** to confirm.
    ...
    <figure><img src="../../../../.gitbook/assets/clone-org-3screens_02oct202okta-saml-application-creation.png" alt="Review summary of what will be copied to the new Organization and Create"><figcaption><p>Review summary of what will be copied to the new Organization and Create</p></figcaption></figure>

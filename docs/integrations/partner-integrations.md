...
| [Devin](snyk-studio-agentic-integrations/quickstart-guides-for-snyk-studio/devin-guide.md)                                     | Secure LLM-generated code in Devin using Snyk Studio (including Snyk's MCP server). Authentication will be requested upon first use.                                                                                                                                      |
| [Factory](snyk-studio-agentic-integrations/quickstart-guides-for-snyk-studio/factory-guide.md)                                 | Secure LLM-generated code from agentic workflows using Snyk Studio and the MCP server within Factory. Authentication required on first use.                                                                                                                               |
| [Factory Terminal](snyk-studio-agentic-integrations/quickstart-guides-for-snyk-studio/factory-terminal-ide-guide.md)           | Secure LLM-generated code (via agentic workflows) using Snyk Studio (with MCP server) in Factory Terminal/IDE. Install Snyk Studio directly.                                                                                                                              |
...
| [Docker Hub](../developer-tools/snyk-ci-cd-integrations/github-actions-for-snyk-setup-and-checking-for-vulnerabilities/snyk-docker-action.md) | Snyk integrates with Docker Hub to enable you to import snapshots of your projects to our UI and then test and monitor image layers.                                                                                                                                                                                         |
...
| Integration                                                                                                          | Description                                                                                                                                                                                |
| -------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [Bitbucket Cloud App](../developer-tools/scm-integrations/organization-level-integrations/bitbucket-cloud-app.md)    | Find, prioritize and fix security vulnerabilities in your code for free without leaving Bitbucket Cloud.                                                                                   |
| [Bitbucket Pipelines](../developer-tools/snyk-ci-cd-integrations/bitbucket-pipelines-integration-using-a-snyk-pipe/) | <p>Fix quickly and early with actionable remediation<br>Scan builds with Bitbucket Pipelines<br>Fix quickly to reduce exposure</p>                                                         |

---
description: Review the support and success offering terms available to Snyk Enterprise customers, including response SLAs, training, and technical success manager access.
---
...
For customers with legacy success offerings that are no longer available for new purchases, see [Legacy Success Offerings](legacy-success-offerings.md).
...
**Customer Portal:** All Snyk Enterprise Plan customers have access to the Snyk Customer Portal, which includes AI-assisted enterprise search functionality to answer your questions. [https://support.snyk.io/s/](https://support.snyk.io/s/)
...
#### Flex Success offering

**Pooled Technical Success Manager:** The Flex Success Offering includes twelve bookable sessions (One-hour each) with a pooled TSM per contract year. The annual balance of twelve do not roll over to another year. A pooled TSM is available upon request, as initiated by the Customer through their Snyk Sales Account Executive or the Snyk Customer Portal (as applicable). A pooled TSM will be made available upon request to support your Snyk account as it grows and evolves.

**Guided onboarding**: A Snyk Consultant will guide the Customer throughout onboarding, ensuring the Customer is enabled with the following:

* Effective account configuration
* Group configuration, including Policies, Asset Inventory, and Custom Roles
* Template Org configuration, including Integrations and per-product configuration
* Org structure definition/creation and SSO configuration to align with this
...
The dedicated hours are a guideline intended to set expectations, rather than a contractual term. If the Customer needs more time one week, and less the next, the TSM will be flexible and adherent.
...
Response times are dependent on the severity of the ticket, the Snyk Plan purchased (Free or Team versus Enterprise), and the Success Offering purchased (Standard, Flex, Gold, Platinum).

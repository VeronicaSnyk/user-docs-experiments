...
<figure><img src="../../.gitbook/assets/create-github-app-account-setting-selection.png" alt="Create GitHub App account setting selection"><figcaption><p>Create GitHub App account setting selection</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/registration-success-message-link-private-key-generation.png" alt="Registration success message with a link for private key generation"><figcaption><p>Registration success message with a link for private key generation</p></figcaption></figure>

7. Scroll to the top of the page and click **Install App** on the navigation panel. Click the **Install** button for your app.

<figure><img src="../../.gitbook/assets/install-github-app-repositories.png" alt="Install the GitHub App in your repositories"><figcaption><p>Install the GitHub App in your repositories</p></figcaption></figure>

8. Choose where you want to install the app in your GitHub organization. It can be installed in specific repositories or all of them.

<figure><img src="../../.gitbook/assets/install-github-app-selected-repositories.png" alt="Install the GitHub App in your selected repositories" width="563"><figcaption><p>Install the GitHub App in your selected repositories</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/successful-github-server-app-integration.png" alt="A successful GitHub Server App integration"><figcaption><p>A successful GitHub Server App integration</p></figcaption></figure>
